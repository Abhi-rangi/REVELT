...
const comparisonRows = [
  {
    area: "Incoming Calls",
    without: "Missed calls, voicemails ignored",
    withR: "Instant AI response, booking confirmed",
  },
  {
    area: "Social DMs",
    without: "Hours or days without reply",
    withR: "Automated reply in under 30 seconds",
  },
  {
    area: "Lead Follow-Up",
    without: "Manual, inconsistent, forgotten",
    withR: "Smart automated sequences, every time",
  },
  {
    area: "Appointment Slots",
    without: "Empty slots from no-shows",
    withR: "Full calendar with confirmation reminders",
  },
  {
    area: "Staff Workload",
  ...
  {
    area: "Revenue",
    without: "Leaking from every missed opportunity",
    withR: "Captured, converted, and booked",
  },
];
            ...
            <table className="w-full text-left text-sm">
              <thead>
                <tr className="border-b border-border bg-secondary">
                  ...
                  <th className="px-6 py-4 font-semibold text-destructive">
                    Without REVELT
                  </th>
                  <th className="px-6 py-4 font-semibold text-teal">
                    With REVELT
                  </th>
                </tr>
              </thead>
